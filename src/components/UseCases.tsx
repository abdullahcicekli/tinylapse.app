      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {useCases.map((useCase, index) => {
          ...
          return (
            <div
              key={index}
              className="group relative bg-gradient-to-br from-gray-900 to-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-brand-green/70 hover:shadow-2xl hover:shadow-brand-green/20 hover:scale-105 hover:-translate-y-1 transition-all duration-300 cursor-pointer overflow-hidden"
            >
              ...
              <div className="relative flex items-start space-x-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-semibold group-hover:text-brand-green transition-colors duration-300">{useCase.title}</h3>
                  <p className="text-gray-400 text-sm group-hover:text-gray-300 transition-colors duration-300">{useCase.description}</p>
                </div>
              </div>
            </div>
          )
