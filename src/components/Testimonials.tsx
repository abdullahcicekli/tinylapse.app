...
export default function Testimonials() {
  ...
  return (
    <section className="section-container bg-gray-50 dark:bg-gray-900/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {testimonials.map((testimonial, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl p-8 hover:border-brand-green/30 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-brand-green/10"
          >
